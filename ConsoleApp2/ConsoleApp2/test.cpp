// если рядом есть .ini файл, то считываются значения ключей: 
// prog - путь до файла, 
// args - аргументы для файла, 
// wdir - рабочая папка файла, 
// show - видимость окна файла hide, min, max
// если ini файла не наблюдается, скрыто запускается .bat файл
// имена файлов должны совпадать с исполяемым
